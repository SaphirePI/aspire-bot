...
module.exports = {
    name: 'kick',
    description: 'Кикну пользователя с сервера',
    aliases: [],
    public: true,
    async execute(client, message, args, config, settings) {
        ...
        let embed = new Discord.RichEmbed()
            .setTitle('Кик - ожидает утверждения')
            .setDescription(`:warning: | Вы собираетесь кикнуть ${member.user.tag} на данном сервере.
